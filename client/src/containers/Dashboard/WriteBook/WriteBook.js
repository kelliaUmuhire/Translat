...
class WriteBook extends Component {
  constructor(props) {
    ...
    this.state = {
      editorState: EditorState.createWithContent(
        ContentState.createFromText("Choose a page and start editing!")
      ),
      content: {},
      tableOfContent: null,
      show: false,
  ...
  render() {
    return (
      <div className="container writebook">
        ...
        <div className="row">
          ...
          <div className="content shadow col-10 col-sm-10">
            ...
            <button
              ...
              className={`btn ml-5 ${this.state.saved ? "text-success" : ""}`}
            >
              <i className="fas fa-save"></i>
              {this.state.saved ? "  Saved!" : "  Save"}
            </button>
            {/* <button className="bg-light btn ml-5">
              <i class="fa fa-upload" aria-hidden="true"></i> Publish page
            </button> */}
            <Editor
